...
\begin{document}
	...
	\texttt{localStorage} del navegador. Al cargar el dashboard,
	una instrucci\'{o}n de JavaScript reemplaza el texto
	est\'{a}tico por el valor de \texttt{AppState.user.name},
	mostrando as\'{i} un saludo personalizado: ``\~{B}uenos
	d\'{i}as, \~{J}uan~\~{P}ablo!'' o ``\~{B}uenos d\'{i}as,
	\~{M}ar\'{i}a!'', seg\'{u}n corresponda.
